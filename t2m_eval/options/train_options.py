...
class TrainDecompOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/cpfs04/shared/sport/zouyude/code/lingo-release/t2m_eval/checkpoints', help='models are saved here')
