...
@hydra.main(version_base=None, config_path="config", config_name="config_train_infbagel_mix_cm")
...
def train_ddp(rank, world_size, cfg):
    ...
    for epoch in range(cfg.start_epoch, cfg.epochs):
        ...
        for batch in dataloader:
            ...
            loss_dict = trainer.consistency_loss(x_start, joints, mat, scene_flag, mask, t, text_clip_embedding, pelvis_goal, hand_goal, object_goal, \
        ...
        if rank == 0 and epoch % cfg.ckpt_interval == 0:
            ...
            torch.save(student_model.module.state_dict(), os.path.join(ckpt_folder, f"{cfg.exp_name}_epoch{epoch:03d}.pth"))
