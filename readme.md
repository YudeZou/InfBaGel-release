...
1. **Prepare Data and Model Files**:
    ...
    - `checkpoint/` — Consistency model checkpoints (trained on OMOMO dataset only); download [checkpoint.tar.gz](https://drive.google.com/open?id=1h6k38uogfQ9V_z4ZO2kfyi03EXTYsoCm) and extract
